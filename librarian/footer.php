    ...
    <footer class="footer">
				...
				<!-- <img class="stilogo" src="../LMS/footer.pn" class="img-rounded"> -->
				</div>
      <div class="container">
	  <div class="foot-margin">
	  <p><a> Abibat And Jomiloju Library . &copy; All Rights Reserved.</a> Designed By <a href="https://github.com/oluokunkabiru">ABIBAT and JOMILOJU</a></p>
      </div>
      </div>
    </footer>
